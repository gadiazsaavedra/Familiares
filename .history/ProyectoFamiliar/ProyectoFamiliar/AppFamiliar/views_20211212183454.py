...
def  abuelosFormulario(request):
    if request.method == 'POST':
        ...
        if miFormulario.is_valid():
                ...
                abuelos = Abuelos(nombre=informacion['nombre'], apellido=informacion['apellido'], direccion=informacion['direccion'], ciudad=informacion['ciudad'], pais=anio=informacion['anio'],  telefono=informacion['telefono'])                
                abuelos.save()
