...
def  abuelosFormulario(request):
    if request.method == 'POST':
        ...
        if miFormulario.is_valid():
                ...
                abuelos = Abuelos(nombre=informacion['nombre'], apellido=informacion['apellido'], direccion=informacion['direccion'], ciudad=informacion['ciudad'], pais=informacion['pais'], edad=informacion['edad'],  imagen=informacion['imagen'])                
                abuelos.save()
