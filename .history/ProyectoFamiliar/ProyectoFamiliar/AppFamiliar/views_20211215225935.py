...
def eliminarHijo(request, numero_para_borrar):
    ...
    return render(request, 'AppFamiliar/leerHijos.html', {'hijos': hijo})

def leerHijo(request):
    hijo = Hijo.objects.all()
    dir = {"hijo": hijo}
    return render(request, 'AppFamiliar/leerHijo.html', dir)
