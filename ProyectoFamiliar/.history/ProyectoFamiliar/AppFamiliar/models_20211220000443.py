...
class Padre(models.Model):
    ...
    def __str__(self):
        return f"P: {self.nombre} APELLIDO: {self.apellido} TELEFONO: {self.telefono} DIRECCION: {self.direccion} CORREO: {self.correo} FECHA_NACIMIENTO: {self.fecha_nacimiento} PARENTESCO: {self.parentesco}"
