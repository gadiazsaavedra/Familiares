...
class PadresList(ListView):
    ...
    model = Padres
    template_name = "AppFamiliar/cursos_list.html"
    
#Detalle - SUPER Leer - Buscar!!!!!
class PadresDetalle(DetailView):
    
    model = Padres
    template_name = "AppFamiliar/curso_detalle.html"
    
#Crear elementos
class PadresCreacion(CreateView):
    
    model = Padres
    success_url = "../padres/list"
    fields = ["nombre", "apellido", "telefono", "direccion", "correo", "fecha_DeNacimiento"]
    
#modificar!!!!!!!!!!!  
class PadresUpdate(UpdateView):
